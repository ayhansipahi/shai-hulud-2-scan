/**
 * Infected NPM Packages - Wiz Security Shai-Hulud 2 Research
 * Source: https://github.com/wiz-sec-public/wiz-research-iocs
 *
 * This file contains IOCs (Indicators of Compromise) for the supply chain attack
 * discovered by Wiz Security researchers.
 */

// Map of package names to their known infected versions
const INFECTED_PACKAGES = new Map([
  ['02-echo', ['0.0.7']],
...
// All infected package names for quick lookup
const ALL_INFECTED_NAMES = Array.from(INFECTED_PACKAGES.keys());

module.exports = { INFECTED_PACKAGES, ALL_INFECTED_NAMES };
